export const CHAT_WELCOME_MESSAGE =
  "Hi! I'm Christian Lugod's portfolio assistant. Ask me about my skills, work experience, projects, education, awards, or contact information.";
...
export const CHAT_SUGGESTED_QUESTIONS = [
  ...
  "What is Christian's work experience?",
...
Christian Lugod is a Full Stack Developer with 7+ years of experience building scalable, responsive, and SEO-friendly web applications using React, Next.js, Vue, Nuxt, Laravel, Node.js, and modern front-end tooling.

He has experience modernizing legacy websites, delivering accessible mobile-first UI, improving performance, and leading redesigns that increased client conversion rates by up to 200%.

Christian has end-to-end experience from UI/UX mockups and API integration to deployment, optimization, and ongoing maintenance.

Core Skills:
Frontend: HTML, CSS/SCSS, JavaScript, TypeScript, React, Vue, Next.js, Nuxt.js, React Native, Expo, Tailwind CSS, jQuery
Backend: Node.js, PHP, Laravel, REST APIs, PostgreSQL, MySQL, MongoDB
Tools and AI: Git, Docker, Figma, Cursor, ChatGPT, v0
Capabilities: UI/UX design mockups, wireframes, API integration, SEO, performance testing, mobile-first development, WCAG accessibility

Professional Experience:

Full Stack Web Developer — WebDev200
Aug 2020 - Present
- Built and maintained 8+ modern web applications using React, Next.js, Vue, Nuxt, Laravel, and related tooling across desktop and mobile experiences.
...
Description: E-commerce platform for bulk blank apparel sales in the United States.

VDOWorks
Type: Work Project
Role: Project Manager and Full Stack Web Developer
Technologies: PHP, Laravel, PostgreSQL, React, Next.js, Tailwind CSS
Description: Job portal focused on video-form style interviews.

GoNurse
Type: Work Project
Role: Full Stack Web and Mobile Developer
Technologies: Nest.js, LLM, React, React Native, Expo, Next.js, Tailwind CSS
Description: AI assistant tool for doctors and nurses across web and mobile experiences.

HRIS
Type: Work Project
Role: Full Stack Web Developer
Technologies: PHP, Laravel, PostgreSQL, Vue, Nuxt.js, Tailwind CSS
Description: Employee management tools for WebDev200.

HomeOfDevs
Type: Personal Project
Role: Full Stack Web Developer
Technologies: React, Next.js, PostgreSQL, Tailwind CSS
Description: Developer portfolio showcase platform for sharing and discovering web projects.

TUP Manila Organization Web-Based Voting System
Type: Capstone Project
Role: Full Stack Web Developer
Technologies: Node.js, PostgreSQL, JavaScript, Vue.js, Nuxt.js, Heroku
Description: Web-based organization voting system built as a capstone project.

Education:
Bachelor of Science in Information Technology — Technological University of the Philippines (Jun 2018 - Aug 2022)
Information and Communication Technology — Metropolitan Medical Center College of Art, Sciences (Jun 2016 - Apr 2018)

Awards:
Tech-Driven Innovation Award — WebDev200, COO Mr. Roldan Miko N. Suarez, 2024
Best Capstone Project — Computerized Inventory System for Medical Supplies of Metropolitan Medical Center, S.Y. 2017-2018
Best in Technical-Vocational — Information and Communication Technology, S.Y. 2017-2018

Services and availability:
Christian offers full-stack web development, UI/UX implementation, API integration, SEO, performance optimization, mobile-first development, and ongoing maintenance. For project inquiries or hiring, contact him via email or phone listed above.
`.trim();
